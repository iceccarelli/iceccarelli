...
```mermaid
graph TD
    subgraph "Domains of Deep Integration"
        A[High-Voltage Energy Systems<br/>Substations • IEC 61850 • CIM • DER Orchestration • Digital Twins]
        B[Real-Time Software & Agentic Middleware<br/>Embedded → Edge → Cloud • Deterministic Pipelines • Formal Methods]
        C[Applied Scientific AI & Decision Intelligence<br/>Physics-Informed ML • Forecasting • Anomaly Detection • Autonomous Control • XAI]
    end
    A --- B
    B --- C
    A --- C
